...
class TestPurchaseScenario:
    ...
    @pytest.mark.parametrize('case_info', get_testcase_yaml('./api/cases/scenarios/PurchaseScenario.yml'))
...
class TestSalesScenario:
    ...
    @pytest.mark.parametrize('case_info', get_testcase_yaml('./api/cases/scenarios/SalesScenario.yml'))

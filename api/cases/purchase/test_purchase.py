...
class TestPurchase:
    ...
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./api/cases/purchase/buy_add.yaml", flat=True))
    ...
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./api/cases/purchase/buy_get_detail.yaml"))
    ...
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./api/cases/purchase/buy_set_status.yaml"))
    ...
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./api/cases/purchase/payment_add.yaml"))
